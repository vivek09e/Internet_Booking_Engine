...
class TenantRoomGuestLimitControllerTest {
        @Autowired
        ...
        @Test
        public void getAllTenantLimitsByTenantId() throws Exception {
                ...
                mockMvc.perform(MockMvcRequestBuilders.get("/tenantLimit/1").header("Authorization", token)
